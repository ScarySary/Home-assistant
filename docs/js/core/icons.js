const paths = {
  ...
  streaming: '<path d="M4 6.5A2.5 2.5 0 0 1 6.5 4h11A2.5 2.5 0 0 1 20 6.5v9a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 15.5v-9Z"/><path d="m10 8 5 3-5 3V8Z"/><path d="M8 21h8"/>',
  analytics: '<path d="M4 19V5"/><path d="M4 19h17"/><path d="M8 16v-5"/><path d="M12 16V8"/><path d="M16 16v-3"/><path d="M20 16V6"/>',
  assistant: '<path d="M12 3a7 7 0 0 1 7 7v3a7 7 0 0 1-14 0v-3a7 7 0 0 1 7-7Z"/><path d="M9 11h.01"/><path d="M15 11h.01"/><path d="M9 16c1.7 1 4.3 1 6 0"/><path d="M12 21v-2"/>',
  pantry: '<path d="M5 4h14v17H5z"/><path d="M8 8h8"/><path d="M8 12h8"/><path d="M8 16h5"/>',
  fridge: '<path d="M7 3h10a2 2 0 0 1 2 2v16H5V5a2 2 0 0 1 2-2Z"/><path d="M5 11h14"/><path d="M9 7v1"/><path d="M9 15v1"/>',
  ...
  household: '<path d="M3 11 12 4l9 7"/><path d="M5 10.5V20h14v-9.5"/><path d="M9 20v-5h6v5"/>',
